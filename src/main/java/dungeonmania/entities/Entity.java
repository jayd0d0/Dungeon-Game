...
public abstract class Entity {
    ...
    public List<Position> getCardinalAdjPositions() {
        return position.getCardinallyAdjacentPositions();
    }

    public void setTurnsStopped(int haltedTurns) {
        this.turnsStopped = haltedTurns;
    }

    public int getTurnsStopped() {
        return this.turnsStopped;
    }

    public boolean isStuckInSwamp() {
        int numMovesStuck = getTurnsStopped();
        if (numMovesStuck > 0) {
            numMovesStuck--;
            setTurnsStopped(numMovesStuck);
            return true;
        }
        return false;
    }
