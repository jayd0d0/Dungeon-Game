...
public class GameMap {
    ...
    private void initRegisterSpawners() {
        ...
        game.register(() -> game.spawnSpiders(game), Game.AI_MOVEMENT, "spawnSpiders");
    }
    ...
    public void battleEntity(Player player, Enemy enemy) {
        game.battle(player, enemy);
    }

    public Potion getEffectivePlayerPotion() {
