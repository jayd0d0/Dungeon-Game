...
public class GameBuilder {
    ...
    public Game buildConfig(String dungeonName, String configName) {
        return setConfigName(configName).buildDungeon(dungeonName);
    }

    public Game buildDungeon(String dungeonName) {
        return setDungeonName(dungeonName).buildGame();
    }
}
